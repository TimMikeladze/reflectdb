 ...
 *
 * Vendored verbatim from `services/presence/protocol.ts` — the landing page is
 * deployed from `landing/` alone and cannot import across the repo. Keep the
 * two in sync; this copy exists for the deploy boundary, not to diverge.
 *
